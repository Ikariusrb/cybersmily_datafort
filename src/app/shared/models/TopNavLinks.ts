...
export class TopNavLinks {
  ...
  constructor() {
    ...
    this.menuItems.push({
      groupTitle: 'Data',
      description:
        'Under Data you will find charts, listings, and some adapted content.',
      links: [
        {
          title: 'CH2 Conversion',
          link: 'data/chrome2',
        ...
        {
          title: 'Master Cyberdecks List',
          link: 'data/cyberdeck',
          desc: 'List of all canon Cyberdecks in Cyberpunk 2020',
        },
        {
          title: 'Master Gear List',
          link: 'data/gear',
          desc: 'List of all canon Gear in Cyberpunk 2020',
        },
        {
          title: 'Master Programs List',
          link: 'data/programs',
          desc: 'List of all canon programs in Cyberpunk 2020',
        },
        {
          title: 'Master Roles List',
          link: 'data/roles',
          desc: 'List of all canon roles in Cyberpunk 2020',
        },
        {
        ...
        },
        {
          ...
          link: 'data/proteus/prog',
          desc: 'Convert programs based from the Netrunner CCG expansion.',
        },
        {
          title: 'Proteus - Decks, Cyber, Gear',
          link: 'data/proteus/gear',
          desc: 'Convert gear based from the Netrunner CCG expansion.',
        },
        {
          title: 'Proteus - Sysops',
          link: 'data/proteus/sysops',
      ...
      links: [
        {
          title: 'Cyberware',
          link: 'shop/cyber',
          desc: 'Custom cyberware for Cyberpunk 2020',
        },
        {
          title: 'Gear',
          link: 'shop/gear',
          desc: 'Custom gear for Cyberpunk 2020',
        },
        {
          title: 'Other',
          link: 'shop/other',
          desc: 'Custom services and other options for Cyberpunk 2020',
        },
      ],
    });
    this.menuItems.push({
      ...
      links: [
        {
          title: 'Cops/Corps',
          link: 'peeps/copscorps',
          desc: 'Cop and Corporate NPCs',
        },
        {
          title: 'Fixers/Medias',
          link: 'peeps/fixermedia',
          desc: 'Fixer and Media NPCs',
        },
        {
          title: 'Medtechs/Netrunners',
          link: 'peeps/medtechnr',
          desc: 'Metech and Netrunner NPCs',
        },
        {
          title: 'Nomads/Rockers',
          link: 'peeps/nomadrocker',
          desc: 'Nomad and Rocker NPCs',
        },
        {
          title: 'Solos/Techies',
          link: 'peeps/solotechie',
          desc: 'Solo and Techie NPCs',
        },
      ...
      links: [
        {
          title: 'Dy in Lyte',
          link: 'gigs/dynlyte',
          desc: 'Scenario with using Ianus Edge of Night supplement.',
        },
        {
          title: 'Got...',
          link: 'gigs/got',
          desc: 'Story about blackmail, murder, and investigation.',
        },
        {
          title: 'Prometheus Chronicles',
          link: 'gigs/prometheus',
          desc: 'Campaign for the getting stolen product back to BMS',
        },
        {
          title: 'WNS News Force Reports',
          link: 'gigs/wns7',
          desc: 'News nuggets taking place during the 4th Corporate War.',
        },
      ],
    });
    this.menuItems.push({
      ...
      links: [
        {
          title: 'ACPA Generator',
          link: 'apps/acpa',
          desc: 'ACPA genereator for Cyberpunk 2020.',
        },
        {
        ...
        {
          title: 'Combat Zone Generator',
          link: 'apps/cmbtzone',
          desc: 'Cyberpunk 2020 Combat Zone generator will create a map of 3x4 blocks, with street objects and event rolls.',
        },
        {
          title: 'Datafort Designer',
          link: 'apps/dfdesigner',
          desc: 'Datafort designer for Cyberpunk 2020.',
        },
        {
          title: 'Drug Lab',
          link: 'apps/druglab',
          desc: 'Cyberpunk 2020 Drug Lab rules.',
        },
        {
          title: 'Fashion Calculator',
          link: 'apps/fashcalc',
          desc: 'Cyberpunk 2020 Clothes creation and list.',
        },
        {
          title: 'Fixer Calculator',
          link: 'apps/fixcalc',
        ...
        {
          title: 'LifePath Generator',
          link: 'apps/lifepath',
          desc: 'Cyberpunk 2020 Lifepaht generator.',
        },
        {
          title: 'Max Metal Calculator',
          link: 'apps/maxmetal',
          desc: 'Cyberpunk 2020 vehicle designer using Maximum Metal rules.',
        },
        {
          title: 'Netrunner Navigator',
          link: 'apps/nrtrace',
          desc: 'Cyberpunk 2020 netrunning map for accumulating trace and doing a run.',
        },
        {
          title: 'Netrunner Cyberdeck Manager',
          link: 'apps/deckmgr',
    ...
    this.menuItems.push({
      ...
      links: [
        ...
        },
        {
          ...
          link: 'apps/redlifepath',
          desc: 'Lifepath generator for Cyberpunk Red.',
        },
        {
          title: 'Headline Generator',
          link: 'apps/headlines',
        ...
        {
          title: 'NET Architect Generator',
          link: 'apps/rednet',
          desc: 'Cyberpunk Red NET Architect generator.',
        },
        {
          title: 'Night Market Generator',
          link: 'apps/nightmarket',
          desc: 'Night Market generator for Cyberpunk Red.',
        },
        {
          title: 'Vendit Generator',
          link: 'apps/nightmarket',
          desc: 'Vendit generator for Cyberpunk Red.',
        },
        {
    ...
    this.menuItems.push({
      ...
      links: [
        ...
        },
        {
          title: 'NC JPG Maps',
          link: 'dlow/maps',
          desc: 'Night City jpg files',
        },
        {
          title: 'NC Blueprints',
          link: 'dlow/blueprints',
          desc: 'Night City png and Campaign Cartographer blue print files',
        },
      ],
    });
    this.menuItems.push({
      groupTitle: 'LDLs',
      description:
        'Under LDLs you will find links to other Cyberpunk 2020/RED sites.',
      links: [
        {
          title: 'R. Talsorian',
          link: 'https://rtalsoriangames.wordpress.com/',
          desc: 'The main site for news and books for Cyberpunk.',
          target: '_blank',
        },
        {
          title: 'Cyberpunk 2077',
          link: 'http://cyberpunk.net/',
          desc: 'Computer game from CD Projekt Red',
          target: '_blank',
        },
        {
          title: 'CBR PNK HUB',
        ...
        {
          title: 'BlackHammer Project',
          link: 'http://www.ambient.ca/cpunk/',
          desc: 'Another site to check out. Tons of content.',
          target: '_blank',
        },
        {
          title: 'Cybernation Uncensored',
          link: 'https://www.cybernationuncensored.com/',
          desc: 'New site to the scene. Rob Mulligan from Mulligan Live is pushing the game to the masses.',
          target: '_blank',
        },
        {
          title: 'Cyberpunk Red Generator',
          link: 'https://cyberpunk-char-gen.neocities.org',
          desc: 'Great utility for Cyberpunk Red character generation.',
          target: '_blank',
        },
        {
          title: 'Datapool 2045',
          link: 'https://datapool2045.net/',
          desc: 'Cool site with links to help guide edgerunners to things Cyberpunk',
          target: '_blank',
        },
        {
          title: 'Eric Dorsey CP Generator',
          link: 'https://ericdorsey.info/cp2020/index.html',
          desc: 'Great utility for Cyberpunk 2020 character generation.',
          target: '_blank',
        },
        {
          title: 'Karstens CP Arch.',
          link: 'https://www.cyberpunk2020.de/',
          desc: 'One of the originals. ',
          target: '_blank',
        },
        {
          title: 'Laurel Cadre Goon Generator',
          link: 'http://www.laurelcadre.com/cp_goon/',
          desc: 'Nice way of craete quick NPCs for the game.',
          target: '_blank',
        },
        {
          title: 'Mockery',
          link: 'http://www.verminary.com/cyberpunk/',
          desc: 'An old but goodie. Great articles.',
          target: '_blank',
        },
        {
          title: 'Montreal Dataterm',
          link: 'https://montreal.dataterm.ca/en/login/',
          desc: 'A great new site to check out. Love the layout and ads',
          target: '_blank',
        },
        {
          title: 'Moosh Cyberpunk Generator',
          link: 'https://www.moosh.net/cp2020/',
          desc: 'Cooll little utiltiies',
          target: '_blank',
        },
        {
          title: 'Paper Dragon.',
          link: 'http://www.paper-dragon.com/',
          desc: 'This is a site that inspired me to create this datafort.',
          target: '_blank',
        },
        {
          title: 'SkethcFab NC map',
          link: 'https://sketchfab.com/3d-models/night-city-2020-schematic-map-7ba41a4a19574bb38bf744d7017df48c',
          desc: 'Real nice 3d map of Night City.',
          target: '_blank',
        },
        {
          title: 'Views from the Edge',
          link: 'http://vfte.cyberpunk.co.uk/',
          desc: 'Great site form the UK. Has a active forum.',
          target: '_blank',
        },
      ],
    });
    this.menuItems.push({
      groupTitle: 'Vids',
      description:
        'Under Vids you will find links to videos, webisodes, and streams for Cyberpunk 2020/Red.',
      links: [
        {
          title: 'Cybernation Uncensored',
          link: 'https://www.youtube.com/channel/UClWubbkZ7eONxjD9f98mGjg',
          desc: 'Liveplay, advice, reviews',
          target: '_blank',
        },
        {
        ...
        },
        {
          ...
          desc: 'One of the first liveplays for Cyberpunk.',
          target: '_blank',
        },
        {
          title: 'HSG Cyberpunk 2020',
        ...
        {
          title: 'Mad Queen Show',
          link: 'https://www.youtube.com/channel/UC0G5rpOFcY6pOdtKsCE0p2A',
          desc: 'Lore Galore. Mostly concentration on CP 2077',
          target: '_blank',
        },
        {
        ...
        {
          title: 'PunkGenerator',
          link: 'https://www.youtube.com/channel/UCrB_VVl4kFsMiQFw_h6RKfg',
          desc: 'Reviews and live play.',
          target: '_blank',
        },
        {
          title: 'Seth Skorkowsky',
          link: 'https://www.youtube.com/channel/UCQs8-UJ7IHsrzhQ-OQOYBmg',
          desc: 'Great advise for all TTRPGs, but has a few specifically for Cyberpunk',
          target: '_blank',
        },
        {
          title: 'Tabletop Cyberpunk 2020',
          link: 'https://www.youtube.com/watch?v=efRE_tqUkhY&list=PLr8mrSTjqGo6-A9QBncTWvj96GKALCfae',
          desc: 'Liveplay. If not the first, definitely one of the earliest.',
          target: '_blank',
        },
        {
  ...
  public isSiteLink(val: any): boolean {
    return (
      (typeof val.title !== 'undefined' && typeof val.link !== 'undefined') ||
      typeof val.desc !== 'undefined'
    );
  }
}
